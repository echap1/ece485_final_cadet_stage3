...
begin
    ...
    process(reset, if_id_mem_read, if_id_load_addr, if_id_rd, rs1, rs2, if_id_opcode, opcode, stall_counter)
    begin
        if (reset = '1') then
            start_stall <= '0';
        -- stall cases, dependency on a (1)load from memory, (2) load_addr, (3) add, (4) addi/subi
        elsif ((if_id_opcode = "0000011" or  -- LW
                if_id_opcode = "0010111" or  -- load_addr
                if_id_opcode = "0110011" or  -- ADD
                if_id_opcode = "0010011")    -- ADDI/SUBI
               and if_id_rd /= "00000"  -- dest register is not zero
               and (rs1 = if_id_rd or rs2 = if_id_rd)  -- dest register matches rs1 or rs2
              ...
              ((if_id_opcode = "1100011" or if_id_opcode = "1101111")
